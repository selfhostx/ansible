...
| baserole_package_install_recommends_and_suggestions | Install optional recommended and suggestions (called weak dependencies on RedHat) | boolean (true, false) | yes | True |
